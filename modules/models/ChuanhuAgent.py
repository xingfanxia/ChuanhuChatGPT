...
class ChuanhuAgent_Client(BaseLLMModel):
    def __init__(self, model_name, openai_api_key, user_name="") -> None:
        ...
        self.llm = ChatOpenAI(openai_api_key=openai_api_key, temperature=0, model_name=os.environ.get("DEFAULT_MODEL", default_chuanhu_assistant_model), openai_api_base=os.environ.get("OPENAI_API_BASE", None))
